...
• ADCS keeps the satellite <mark style="background: #BBFABBA6;">stable and correctly oriented </mark> 
...
• Built a <mark style="background: #BBFABBA6;">working attitude control system using a reaction wheel  </mark>
